  ...
  return (
    <section id="foerderung" className="bg-white py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="reveal relative overflow-hidden rounded-3xl bg-brand px-6 py-12 text-white sm:px-10 lg:px-14 lg:py-14">
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto] lg:gap-14">
            <div>
              ...
              <a
                href="#kontakt"
                className="btn-cta btn-cta--light mt-7 inline-flex items-center rounded-full bg-white px-7 py-3.5 font-semibold text-brand shadow-sm transition-transform hover:scale-[1.02]"
              >
                <span className="btn-label" data-text="Fördercheck starten →">
                  Fördercheck starten →
                </span>
              </a>
            </div>
